...
\section {Kevin Natanael Nainggolan 1174059}
	\begin {enumerate}
		\item Apa itu fungsi csv, jelaskan sejarah dan contohnya 
			\lstinputlisting [firstline=10, lastline=14]{src/chapter4/teori_1174059.py}
		\item Aplikasi-aplikasi apa saja yang bisa menciptakan file csv? 
			\lstinputlisting [firstline=18, lastline=22]{src/chapter4/teori_1174059.py}
		\item Jelaskan bagaimana cara menulis dan membaca file csv di excel atau spreadsheet
			\lstinputlisting [firstline=26, lastline=39]{src/chapter4/teori_1174059.py}
		\item Jelaskan sejarah library csv
			\lstinputlisting [firstline=43, lastline=50]{src/chapter4/teori_1174059.py}
		\item Jelaskan sejarah library pandas
			\lstinputlisting [firstline=54, lastline=60]{src/chapter4/teori_1174059.py}
		\item Jelaskan fungsi-fungsi yang terdapat di library csv
			\lstinputlisting [firstline=64, lastline=68]{src/chapter4/teori_1174059.py}
		\item Jelaskan fungsi-fungsi yang terdapat di library pandas
			\lstinputlisting [firstline=72, lastline=75]{src/chapter4/teori_1174059.py}
	\end {enumerate}
